...
export default function PrivacyContent() {
  return (
    <>
      <p>
        手作り工房『こみち』では、お客様からお預かりする個人情報の重要性を強く認識し、個人情報の保護に関する法律、その他の関係法令を遵守すると共に、以下に定めるプライバシーポリシーに従って、個人情報を安全かつ適切に取り扱うことを宣言いたします。
      </p>
      <h3>個人情報の定義</h3>
      <p>
      ...
      <p>お客様からお申し込みいただいたサービス等の提供のため。</p>
      ...
      <p>
        ...
        から、Cookieを使用したパーソナライズ広告を無効にすることができます。なお、Cookieに保存されている情報からお客様個人を特定することはできません。
      </p>
      <Spacer />
      <p>
